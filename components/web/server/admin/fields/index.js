...
exports.find = function (req, res, next) {
  ...
  req.app.db.models.Field.pagedFind({
    ...
    if (req.xhr) {
      ...
      results.filters = req.query;
      res.render('web/server/admin/fields/index', {data: {results: escape(JSON.stringify(results))}});
    }
  });
};
...
exports.read = function (req, res, next) {
  req.app.db.models.Field.findById(req.params.id).exec(function (err, field) {
    ...
    if (req.xhr) {
      ...
      res.render('web/server/admin/fields/details', {data: {record: escape(JSON.stringify(field))}});
    }
  });
};
